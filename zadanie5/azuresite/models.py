...
class KonkurzRestrukturalizaciaIssues(models.Model):
    ...
    raw_issue = models.ForeignKey('RawIssues', on_delete=models.CASCADE)
    ...
    debtor = models.ForeignKey(KonkurzRestrukturalizaciaActors, on_delete=models.CASCADE, blank=True, null=True)
...
class OrPodanieIssueDocuments(models.Model):
    or_podanie_issue = models.ForeignKey('OrPodanieIssues', on_delete=models.CASCADE)
...
class ZnizenieImaniaCeos(models.Model):
    znizenie_imania_issue = models.ForeignKey('ZnizenieImaniaIssues', on_delete=models.CASCADE)
    prefixes = models.CharField(max_length=1000, blank=True, null=True)
    postfixes = models.CharField(max_length=10001, blank=True, null=True)
